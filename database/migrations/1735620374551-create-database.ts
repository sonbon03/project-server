...
export class CreateDatabase1735620374551 implements MigrationInterface {
    name = 'CreateDatabase1735620374551'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "attributes" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "key" character varying NOT NULL, "value" character varying NOT NULL, "status" "public"."attributes_status_enum" NOT NULL, "description" character varying NOT NULL, "amount" integer NOT NULL, "expiryDay" date NOT NULL, "manufactureDate" date NOT NULL, "price" numeric(10,3) NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_32216e2e61830211d3a5d7fa72c" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "products" ADD CONSTRAINT "FK_5e39540b1cb0cac2f77e51fe69f" FOREIGN KEY ("promotionId") REFERENCES "promotion"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
